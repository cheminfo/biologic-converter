...
export const dataColumns: DataColumns = {
  ...
  0x18: { dType: 'Float64', name: 'cycle number', unit: 'flag' },
  ...
  0x27: { dType: 'Uint16', name: 'I Range', unit: 'flag' },
  ...
  0x83: { dType: 'Uint16', name: 'Ns', unit: 'flag' },
  ...
  0x1d4: { dType: 'Uint32', name: 'half cycle', unit: 'flag' },
  0x1d5: { dType: 'Uint32', name: 'z cycle', unit: 'flag' },
...
export const dataColumnsByName: DataColumnsByName = {
  ...
  'Energy/W.h': { name: 'Energy', unit: 'W·h' },
  error: { name: 'error', unit: 'flag' },
  'Ewe-Ece/V': { name: 'Ewe-Ece', unit: 'V' },
  'Ewe/V': { name: 'Ewe', unit: 'V' },
  'freq/Hz': { name: 'freq', unit: 'Hz' },
  'half cycle': { name: 'half cycle', unit: 'flag' },
  'I Range': { name: 'I Range', unit: 'flag' },
  'I/mA': { name: 'I', unit: 'mA' },
  'Im(Y)/Ohm-1': { name: 'Im(Y)', unit: 'S' },
  mode: { name: 'mode', unit: 'flag' },
  'Ns changes': { name: 'Ns changes', unit: 'flag' },
  Ns: { name: 'Ns', unit: 'flag' },
  'NSD Ewe/%': { name: 'NSD Ewe', unit: '%' },
  'NSD I/%': { name: 'NSD I', unit: '%' },
  'NSR Ewe/%': { name: 'NSR Ewe', unit: '%' },
  'NSR I/%': { name: 'NSR I', unit: '%' },
  'ox/red': { name: 'ox/red', unit: 'flag' },
  'P/W': { name: 'P', unit: 'W' },
  ...
  x: { name: 'x', unit: 'flag' },
  'z cycle': { name: 'z cycle', unit: 'flag' },
};
